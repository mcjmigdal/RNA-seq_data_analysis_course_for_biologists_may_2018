...
R_HOME_DIR=
if test "${R_HOME_DIR}" = "/home/mmigdal/Documents/phd/rna_seq_workshop_2018/.local/lib64/R"; then
   case "linux-gnu" in
   linux*)
     run_arch=`uname -m`
     case "$run_arch" in
     ...
     if [ -x "/home/mmigdal/Documents/phd/rna_seq_workshop_2018/.local/${libnn}/R/bin/exec/R" ]; then
        R_HOME_DIR="/home/mmigdal/Documents/phd/rna_seq_workshop_2018/.local/${libnn}/R"
     elif [ -x "/home/mmigdal/Documents/phd/rna_seq_workshop_2018/.local/${libnn_fallback}/R/bin/exec/R" ]; then
        R_HOME_DIR="/home/mmigdal/Documents/phd/rna_seq_workshop_2018/.local/${libnn_fallback}/R"
